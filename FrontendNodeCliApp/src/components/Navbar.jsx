        ...
        >
          ...
          {open && (
            <div className="absolute right-0 top-full mt-0.5 z-50 w-48 rounded-lg bg-white shadow-lg p-2">
              <Link
                to="/cart"
                className="mt-2 flex w-full items-center justify-between rounded bg-green-600 px-4 py-2 text-white hover:bg-green-700"
              >
              ...
              <Link
                to="/plan"
                className="mt-2 relative flex items-center justify-between rounded px-4 py-2 bg-purple-600 text-white hover:bg-purple-700"
              >
              ...
              <Link
                to="/admin"
                className="mt-2  flex items-center justify-between rounded px-4 py-2 bg-[#2563EB] text-white hover:bg-[#0638a5]"
              >

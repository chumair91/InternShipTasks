...
const PostCard = ({ title, date, excerpt, id }) => {
  ...
  return (
    <Link to={`/post/${id}`}>
      <div className={`border p-4 h-58  rounded shadow-sm hover:cursor-pointer ${theme==="light"?'hover:bg-cyan-100':'hover:bg-gray-800' }  hover:scale-105 transition-all duration-150`}>
